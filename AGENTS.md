...
Instructions for every agent in this repo — Claude Code, Codex, Cursor and anything else
that reads `AGENTS.md`. `CLAUDE.md` is a symlink to this file, so there is one copy to edit.
